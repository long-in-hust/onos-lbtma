package org.onosproject.pipelines.p4dpads.cli;
...
public class RuleInstaller {
    ...
    // P4 Table and Action IDs from p4_dpads.p4info.txt
    ...
    public RuleInstaller(FlowObjectiveService fos, CoreService cs) {
        ...
        this.appId = coreService.getAppId("org.onosproject.app.p4dpads");
    }
    ...
    public void installStateTableRule(DeviceId deviceId) {
        ...
        // Match fields from your p4_dpads.p4info.txt:
        // hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort, hdr.tcp.dstPort

        // Match: All fields must be matched as EXACT, as per p4_dpads.p4info.txt
